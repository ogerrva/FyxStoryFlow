...
export interface HelpArticle { id: string; title: string; content: string; tags: string[]; }`,
  ...
  "src/locales.ts": `export const translations = {
  en: { dashboard: "Dashboard", newStory: "New Story", calendar: "Calendar", liveLogs: "Live Logs", help: "Help", settings: "Settings", adminUser: "Admin User", queueEmpty: "No active automations.", forceRun: "Force Run", trash: "Trash", confirmDelete: "Are you sure?", clickToUpload: "Click or Drag to upload", status: { PENDING: "PENDING", PUBLISHING: "PUBLISHING", PUBLISHED: "PUBLISHED", FAILED: "FAILED" }, saveSettings: "Save Configuration", saved: "Saved!", igUser: "Instagram Username", igPass: "Instagram Password", headless: "Headless Mode", headlessDesc: "Required for VPS", helpTitle: "Docs", searchHelp: "Search...", phoneLabel: "Phone Number", messageLabel: "Message", stickerTextLabel: "Sticker Button Text", recurrenceLabel: "Repeat Daily", stickerPosTitle: "Interactive Editor", tapToPosition: "Click to position", analyzing: "Analyzing...", generateCaption: "Generate Caption", scheduleAutomation: "Launch Automation" },
  pt: { dashboard: "Painel", newStory: "Novo Story", calendar: "Calendário", liveLogs: "Logs Ao Vivo", help: "Ajuda", settings: "Configurações", adminUser: "Administrador", queueEmpty: "Nenhuma automação ativa.", forceRun: "Executar", trash: "Excluir", confirmDelete: "Tem certeza?", clickToUpload: "Clique ou Arraste", status: { PENDING: "PENDENTE", PUBLISHING: "PUBLICANDO", PUBLISHED: "PUBLICADO", FAILED: "FALHA" }, saveSettings: "Salvar Configurações", saved: "Salvo!", igUser: "Usuário do Instagram", igPass: "Senha do Instagram", headless: "Modo Headless", headlessDesc: "Obrigatório para VPS", helpTitle: "Documentação", searchHelp: "Buscar...", phoneLabel: "Número", messageLabel: "Mensagem", stickerTextLabel: "Texto do Botão", recurrenceLabel: "Repetir Diariamente", stickerPosTitle: "Editor Interativo", tapToPosition: "Toque para posicionar", analyzing: "Analisando...", generateCaption: "Gerar Legenda", scheduleAutomation: "Lançar Automação" }
};
export const helpContent = { 
  en: [{id:'1',title:'Setup',tags:['vps'],content:'Run setup.js'},{id:'3',title:'Headless',tags:['config'],content:'Enable for VPS'}], 
  pt: [{id:'1',title:'Configuração',tags:['vps'],content:'Rode o setup.js'},{id:'3',title:'Headless',tags:['configuração'],content:'Ative para VPS'}] 
};`,
